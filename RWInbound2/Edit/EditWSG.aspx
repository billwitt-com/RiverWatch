<%@ Page Title="Edit WSGs" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditWSG.aspx.cs" Inherits="RWInbound2.Edit.EditWSG" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForWSGsDescription"             
        ...
        <asp:GridView ID="WSGsGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkWSG" 
            SelectMethod="GetWSGs"
            UpdateMethod="UpdateWSG"
            DeleteMethod="DeleteWSG" 
