<%@ Page Title="Edit Quarter Section" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditQuarterSection.aspx.cs" Inherits="RWInbound2.Edit.EditQuarterSection" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForQuarterSectionsDescription"             
        ...
        <asp:GridView ID="QuarterSectionsGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkQuarterSection" 
            SelectMethod="GetQuarterSections"
            UpdateMethod="UpdateQuarterSection"
            DeleteMethod="DeleteQuarterSection" 
