<%@ Page Title="Edit Sub Samp" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditSubSamp.aspx.cs" Inherits="RWInbound2.Edit.EditSubSamp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <asp:GridView ID="SubSampGridView" runat="server"
            DataKeyNames="SubstrateID"
            ItemType="RWInbound2.tblSubSamp" 
            SelectMethod="GetSubSamps"
            UpdateMethod="UpdateSubSamp"
            DeleteMethod="DeleteSubSamp" 
                ...
                <asp:TemplateField>
                    ...
                    <FooterTemplate>
                        <asp:Button ID="btnAdd" runat="server" Text="Add"
                                    OnClick = "AddNewSubSamp" />
                    </FooterTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="SubstrateID" HeaderText="SubstrateID" Visible="false" ReadOnly="True" SortExpression="SubstrateID" />
