<%@ Page Title="Edit WSRs" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditWSR.aspx.cs" Inherits="RWInbound2.Edit.EditWSR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForWSRsDescription"             
        ...
        <asp:GridView ID="WSRsGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkWSR" 
            SelectMethod="GetWSRs"
            UpdateMethod="UpdateWSR"
            DeleteMethod="DeleteWSR" 
