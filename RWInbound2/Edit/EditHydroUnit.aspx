<%@ Page Title="Edit Hydro Unit" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditHydroUnit.aspx.cs" Inherits="RWInbound2.Edit.EditHydroUnit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForHydroUnitsDescription"             
        ...
        <asp:GridView ID="HydroUnitsGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkHydroUnit" 
            SelectMethod="GetHydroUnits"
            UpdateMethod="UpdateHydroUnit"
            DeleteMethod="DeleteHydroUnit" 
