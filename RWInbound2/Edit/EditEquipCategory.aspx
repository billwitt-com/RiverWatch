<%@ Page Title="Equipment Category" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditEquipCategory.aspx.cs" Inherits="RWInbound2.Edit.EditEquipCategory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <asp:GridView ID="EquipCategoriesGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkEquipCategory" 
            SelectMethod="GetEquipCategories"
            UpdateMethod="UpdateEquipCategory"
            DeleteMethod="DeleteEquipCategory" 
