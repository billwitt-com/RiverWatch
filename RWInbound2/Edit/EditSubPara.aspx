<%@ Page Title="Edit Sub Para" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditSubPara.aspx.cs" Inherits="RWInbound2.Edit.EditSubPara" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" ClientIDMode="Static" runat="server">
    ...
    <asp:FormView ID="SubParaFormView" runat="server" 
        DataKeyNames="SubParaID"
        ItemType="RWInbound2.tlkSubPara" 
        SelectMethod="GetSubParas"
        UpdateMethod="UpdateSubPara"
        DeleteMethod="DeleteSubPara"
        InsertMethod="InsertSubPara"
        AllowPaging="true" >   
