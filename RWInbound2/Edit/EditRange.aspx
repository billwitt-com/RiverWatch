<%@ Page Title="Edit Range" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditRange.aspx.cs" Inherits="RWInbound2.Edit.EditRange" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForRangesDescription"             
        ...
        <asp:GridView ID="RangesGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkRange" 
            SelectMethod="GetRanges"
            UpdateMethod="UpdateRange"
            DeleteMethod="DeleteRange" 
