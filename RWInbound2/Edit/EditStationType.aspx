<%@ Page Title="Edit Station Type" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditStationType.aspx.cs" Inherits="RWInbound2.Edit.EditStationType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <p>
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForStationTypesDescription"             
        ...
        <asp:GridView ID="StationTypesGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkStationType" 
            SelectMethod="GetStationTypes"
            UpdateMethod="UpdateStationType"
            DeleteMethod="DeleteStationType" 
