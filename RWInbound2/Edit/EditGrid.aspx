<%@ Page Title="Edit Grids" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditGrid.aspx.cs" Inherits="RWInbound2.Edit.EditGrid" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForGridsDescription"             
        ...
        <asp:GridView ID="GridsGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkGrid" 
            SelectMethod="GetGrids"
            UpdateMethod="UpdateGrid"
            DeleteMethod="DeleteGrid" 
