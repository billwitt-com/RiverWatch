<%@ Page Title="Edit WQCC Water Sheds" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditWQCCWaterShed.aspx.cs" Inherits="RWInbound2.Edit.EditWQCCWaterShed" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForWQCCWaterShedsDescription"             
        ...
        <asp:GridView ID="WQCCWaterShedsGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkWQCCWaterShed" 
            SelectMethod="GetWQCCWaterSheds"
            UpdateMethod="UpdateWQCCWaterShed"
            DeleteMethod="DeleteWQCCWaterShed" 
