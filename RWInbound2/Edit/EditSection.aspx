<%@ Page Title="Edit Sections" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditSection.aspx.cs" Inherits="RWInbound2.Edit.EditSection" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
               ...
               <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForSectionsDescription"             
        ...
        <asp:GridView ID="SectionsGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkSection" 
            SelectMethod="GetSections"
            UpdateMethod="UpdateSection"
            DeleteMethod="DeleteSection" 
