<%@ Page Title="Edit QUADI" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditQUADI.aspx.cs" Inherits="RWInbound2.Edit.EditQUADI" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForQUADIDescription"             
        ...
        <asp:GridView ID="QUADIGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkQUADI" 
            SelectMethod="GetQUADI"
            UpdateMethod="UpdateQUADI"
            DeleteMethod="DeleteQUADI" 
