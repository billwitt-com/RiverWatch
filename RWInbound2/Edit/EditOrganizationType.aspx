<%@ Page Title="Edit Organization Type" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditOrganizationType.aspx.cs" Inherits="RWInbound2.Edit.EditOrganizationType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForOrganizationTypesDescription"             
        ...
        <asp:GridView ID="OrganizationTypesGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkOrganizationType" 
            SelectMethod="GetOrganizationTypes"
            UpdateMethod="UpdateOrganizationType"
            DeleteMethod="DeleteOrganizationType" 
                ...
                <asp:TemplateField>
                    ...
                    <FooterTemplate>
                        <asp:Button ID="btnAdd" runat="server" Text="Add"
                                    OnClick = "AddNewOrganizationType" />
                    </FooterTemplate>
                </asp:TemplateField>
