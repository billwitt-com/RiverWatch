<%@ Page Title="Edit River Watch Water Sheds" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditRiverWatchWaterShed.aspx.cs" Inherits="RWInbound2.Edit.EditRiverWatchWaterShed" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForRiverWatchWaterShedsDescription"             
        ...
        <asp:GridView ID="RiverWatchWaterShedsGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkRiverWatchWaterShed" 
            SelectMethod="GetRiverWatchWaterSheds"
            UpdateMethod="UpdateRiverWatchWaterShed"
            DeleteMethod="DeleteRiverWatchWaterShed" 
                ...
                <asp:TemplateField>
                    ...
                    <FooterTemplate>
                        <asp:Button ID="btnAdd" runat="server" Text="Add"
                                    OnClick = "AddNewRiverWatchWaterShed" />
                    </FooterTemplate>
                </asp:TemplateField>
