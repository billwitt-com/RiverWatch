...
namespace RWInbound2
{
    public partial class EditLimits : System.Web.UI.Page
    {
        ...
        {
            lblWelcomeName.Text = string.Format("Welcome {0}", System.Environment.UserName); 
        }
        ...
        {       
         ...
         " from [dbRiverwatchWaterData].[dbo].[ValidationLimits] where id ={0}", e.Command.Parameters[0].Value, System.Environment.UserName) ;
