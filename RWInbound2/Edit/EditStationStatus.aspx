<%@ Page Title="Edit Station Status" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditStationStatus.aspx.cs" Inherits="RWInbound2.Edit.EditStationStatus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForStationStatusDescription"             
        ...
        <asp:GridView ID="StationStatusGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkStationStatu" 
            SelectMethod="GetStationStatus"
            UpdateMethod="UpdateStationStatus"
            DeleteMethod="DeleteStationStatus" 
            ...
            <Columns>  
                ...
                <asp:TemplateField HeaderText="Active" SortExpression="ActiveFlag">
                    <EditItemTemplate>
                        <asp:CheckBox ID="checkBoxActiveFlag" runat="server" Checked='<%# Bind("ActiveFlag") %>' />
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:CheckBox ID="checkBoxActiveFlag" runat="server" Checked='<%# Bind("ActiveFlag") %>' Enabled="false" />
                    </ItemTemplate>
                    <FooterTemplate>
                       <asp:CheckBox ID="NewActiveFlag" runat="server" />
                    </FooterTemplate>
                </asp:TemplateField>                
