<%@ Page Title="Edit Regions" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditRegion.aspx.cs" Inherits="RWInbound2.Edit.EditRegion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section spellcheck="true">
        ...
        <p>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ajaxToolkit:AutoCompleteExtender 
                    ...
                    DelimiterCharacters=""  
                    ServiceMethod="SearchForRegionsDescription"             
        ...
        <asp:GridView ID="RegionsGridView" runat="server"
            DataKeyNames="ID"
            ItemType="RWInbound2.tlkregion" 
            SelectMethod="GetRegions"
