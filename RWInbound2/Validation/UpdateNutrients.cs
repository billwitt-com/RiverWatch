                        ...
                        if (D != null)
                        {
                            foreach (var item in D) // there are multiple ROWS for a barcode in the lachat table, process each one
                            {
                                switch (item.Parameter.ToUpper())
                                {
                                    ...
                                    case "NITRATE-NITRITE":     // NITRATE-NITRITE
                                        if (item.Result != null)
                                        {
                                    ...
                                    case "TOTAL NITROGEN":  // [TotalNitro] - Total Nitrogen
                                        if (item.Result != null)
                                        {
                                    ...
                                    case "TOTAL PHOSPHORUS":             // [TotalPhos]    -- Total Phosphorus
                                        if (item.Result != null)
                                        {
