...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%">
        <tr>
            <td>
                <asp:FormView ID="FormViewBlank" runat="server" AllowPaging="true" DefaultMode="Edit" DataKeyNames="inbICPID" DataSourceID="SqlDataSourceBlanks">
                  <EditItemTemplate>
                ...
                <table id="topTable" runat="server">
                    ...
                    <tr>
                        <td> ZN_D:
                            <asp:TextBox ID="ZN_DTextBox" runat="server" Text='<%# Bind("ZN_D","{0:0.0000}") %>' /></td>
                        <td>
                            <asp:Button ID="btnZN" OnCommand="Button1_Click" CommandArgument="<%=ID %>" runat="server" Text="SWAP" />
                        </td>
                        <td> ZN_T:
                            <asp:TextBox ID="ZN_TTextBox" runat="server" Text='<%# Bind("ZN_T","{0:0.0000}") %>' /></td>
                    </tr>
                    <tr>
                        <td>NA_D:
