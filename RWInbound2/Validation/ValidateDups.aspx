...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style=" align-items: center; vertical-align:top; ">
        <tr >
            <td >              
                <asp:FormView ID="FormViewDup" runat="server"  OnDataBound="FormViewDup_DataBound" AllowPaging="true" DefaultMode="Edit" 
                    DataKeyNames="ID" DataSourceID="SqlDataSourceDups" 
                    OnPageIndexChanging="FormViewDup_PageIndexChanging" >    
                     <EditItemTemplate>
               ...
               <asp:FormView ID="FormViewSample" runat="server" DefaultMode="Edit" DataKeyNames="ID" DataSourceID="SqlDataSourceNormals"  
                    GridLines="Horizontal" BorderStyle="None" BorderWidth="0px">
                     <EditItemTemplate>
                        ...
                        <table id="topTable"  runat="server">
                           <tr >
                            ...
                            <asp:TextBox ID="CA_DTextBox" AutoPostBack="true" OnTextChanged="TextBox_TextChanged"  runat="server" Text='<%# Bind("CA_D","{0:0.00}") %>' />
                                ...
                                <td>
                            <asp:TextBox ID="CA_TTextBox" runat="server" AutoPostBack="true" OnTextChanged="TextBox_TextChanged" Text='<%# Bind("CA_T","{0:0.00}") %>' />
                                </td>
                            </tr>
                        ...
                        SampleID:
                        <asp:TextBox ID="tblSampleIDTextBox" runat="server"  ReadOnly="true" Text='<%# Bind("tblSampleID") %>' />
                        <br />
                     <%--   <asp:Button ID="Button1" CssClass="adminButton" runat="server" CausesValidation="True" OnClick="UpdateButton_Click"  Text="Accept" />--%>
