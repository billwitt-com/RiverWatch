<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrgExample.aspx.cs" Inherits="RWInbound2.OrgExample" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <asp:FormView ID="FormView1" runat="server"  DefaultMode="Edit" DataKeyNames="ID" DataSourceID="SqlDataSourceOrgStatus">
        <EditItemTemplate>
            ID:
            ...
            <asp:TextBox ID="UnknownSpringRecordedDateTextBox" runat="server" Text='<%# Bind("UnknownSpringRecordedDate", "{0:d}") %>' />
            <br />
            UnknownFallRecordedDate:
            <asp:TextBox ID="UnknownFallRecordedDateTextBox" runat="server" Text='<%# Bind("UnknownFallRecordedDate", "{0:d}") %>' />
            <br />
