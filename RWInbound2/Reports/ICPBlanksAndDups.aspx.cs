...
namespace RWInbound2.Reports
{
    public partial class ICPBlanksAndDups : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
         ...
         " ,[orgN] ,[TSS] ,[Valid] FROM [RiverWatch].[dbo].[viewRawSamplesAll] where (typecode = '10' or typecode = '20') order by [StationNumber], [SampleDate]";    // order by [StationNumber], [SampleDate] 
