...
<%--    AutoGenerateColumns="False"--%>
    ...
    <br />
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" OnRowUpdated="GridView1_RowUpdated"   DataKeyNames="ID" DataSourceID="SqlDataSource1">
        <Columns>
            ...
            <asp:CheckBoxField DataField="MissingDataSheetReceived" HeaderText="MDSRReceived" SortExpression="MissingDataSheetReceived" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="UPDATE [InboundSamples] SET [Valid] = 1  WHERE [ID] = @ID" 
