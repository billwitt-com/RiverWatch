...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p style="font-size: medium; text-align: center;"  >
        <strong>Colorado Riverwatch Volunteer Data Entry Form</strong></p>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="157px">
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="tbKitNum" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 24px; height: 20px;"></td>
                ...
                <td>
                    <asp:TextBox ID="tbStationNum" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 24px; height: 20px;">&nbsp;</td>
                ...
                <td>
                    <asp:TextBox ID="tbRiver" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 24px; height: 20px;"></td>
                <td style="width: 142px">Station Name: </td>
                <td>
